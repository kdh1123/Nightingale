...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_api::get_detection_policy,
            tauri_api::update_detection_policy,
            tauri_api::list_allowlist_entries,
            tauri_api::add_allowlist_entry,
            tauri_api::remove_allowlist_entry,
            tauri_api::list_allowlist_audit,
